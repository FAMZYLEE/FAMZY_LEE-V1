...
async function clientstart() {
    ...
    if (usePairingCode && !client.authState.creds.registered) {
        const phoneNumber = await question('𝙿𝚕𝚎𝚊𝚜𝚎 𝚎𝚗𝚝𝚎𝚛 𝚢𝚘𝚞𝚛 𝚆𝚑𝚊𝚝𝚜𝙰𝚙𝚙 𝚗𝚞𝚖𝚋𝚎𝚛, 𝚜𝚝𝚊𝚛𝚝𝚒𝚗𝚐 𝚠𝚒𝚝𝚑 𝟸𝟹𝟺:\n');
        const code = await client.requestPairingCode(phoneNumber.trim());
        console.log(`𝚃𝙷𝙸𝚂 𝚈𝙾𝚄𝚁 𝙿𝙰𝙸𝚁𝙸𝙽𝙶 𝙲𝙾𝙳𝙴 [ ꜰᴀᴍᴢʏ ʟᴇᴇ >]: ${code}`);
    }
 ...
 //BATAS SEND
    client.ev.on('connection.update', async (update) => {
        ...
        if (connection === 'close') {
            ...
            console.log(color('Bot Successfully Connected by FAWAZ LEKAN'));
        }
    });
